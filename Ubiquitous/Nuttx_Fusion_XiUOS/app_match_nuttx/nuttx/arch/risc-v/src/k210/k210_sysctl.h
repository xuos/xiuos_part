...
#define K210_SYSCTL_PLL1  (K210_SYSCTL_BASE + 0x0c)
#define K210_SYSCTL_PLL2  (K210_SYSCTL_BASE + 0x10)
#define K210_SYSCTL_LOCK  (K210_SYSCTL_BASE + 0x18)
#define K210_SYSCTL_SEL0  (K210_SYSCTL_BASE + 0x20)
#define K210_SYSCTL_SEL1  (K210_SYSCTL_BASE + 0x24)
#define K210_SYSCTL_EN    (K210_SYSCTL_BASE + 0x28)
...
#define K210_SYSCTL_CLK_EN  (K210_SYSCTL_BASE + 0x2c)
