...
#define IMXRT_USBPHY2_PWD                   (IMXRT_USBPHY2_BASE + IMXRT_USBPHY2_PWD_OFFSET)      /* USBPHY2 USB PHY Power-Down Register */
#define IMXRT_USBPHY2_PWD_CLR               (IMXRT_USBPHY2_BASE + IMXRT_USBPHY2_PWD_CLR_OFFSET)  /* USBPHY2 USB PHY Power-Down Register Clear */
#define IMXRT_USBPHY2_CTRL                  (IMXRT_USBPHY2_BASE + IMXRT_USBPHY2_CTRL_OFFSET)     /* USBPHY2 USB PHY General Control Register */
#define IMXRT_USBPHY2_CTRL_CLR              (IMXRT_USBPHY2_BASE + IMXRT_USBPHY2_CTRL_CLR_OFFSET) /* USBPHY2 USB PHY General Control Register Clear */
