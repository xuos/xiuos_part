...
STM32F4AIIT.  That board has been replaced with the new order code
...
======================
  ...
  of aiit-arm32-board respectively (Nunchuck also can work connected to 5V, but
...
boards/arm/stm32/aiit-arm32-board/nxlines.  As of this writing, I have not seen the
...
the UG-2864HSWEG01 interface (see boards/arm/stm32/aiit-arm32-board/src/up_ug2864hsweg01.c).
...
BASIC
=====
  I have used the aiit-arm32-board/nsh configuration to test Michael Haardt's
  ...
  aiit-arm32-board/nsh configuration:
...
Enter inside NuttX and compile it:
    ...
    $ tools/configure.sh aiit-arm32-board:testlibcxx
      Copy files
      Refreshing...
...
-------------------------
  ...
  -------
    ...
    Such a configuration is useful on the aiit-arm32-board which has no
