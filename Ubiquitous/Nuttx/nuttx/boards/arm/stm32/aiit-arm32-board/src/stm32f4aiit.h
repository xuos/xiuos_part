/****************************************************************************
 * boards/arm/stm32/stm32f4AIIT/src/stm32f4aiit.h
 *
...
#ifndef __BOARDS_ARM_STM32_AIIT_ARM32_BOARD_SRC_STM32F4AIIT_H
#define __BOARDS_ARM_STM32_AIIT_ARM32_BOARD_SRC_STM32F4AIIT_H
...
/* The NSH Network Monitor cannot be used with the STM32F4AIIT base board.
...
/* PWM
 *
 * The STM32F4 AIIT has no real on-board PWM devices, but the board can
 ...
 *
 * --------------------------+----------------------------------------------
 * Connector CON10 J1:      | STM32F4AIIT
 * --------------+-----------+----------------------------------------------
...
#if (defined(CONFIG_STM32F4DISBB) || defined(CONFIG_STM32F4AIIT)) && defined(CONFIG_STM32_SDIO) 
...
#define GPIO_LCDBL_IN    (GPIO_OUTPUT | GPIO_PUSHPULL | GPIO_SPEED_50MHz |\
                         GPIO_INPUT | GPIO_PORTB| GPIO_PIN3)

#define BOARD_NGPIOINT    1 /* Amount of GPIO Input w/ Interruption pins */
#define GPIO_INT1         (GPIO_INPUT|GPIO_PORTA|GPIO_PIN2)

#define  BOARD_NGPIOOUT 2
#define GPIO_LCDBL     (GPIO_OUTPUT | GPIO_PUSHPULL | GPIO_SPEED_50MHz |\
                         GPIO_OUTPUT | GPIO_PORTD| GPIO_PIN3)

#define GPIO_BEEP     (GPIO_OUTPUT | GPIO_PUSHPULL | GPIO_SPEED_50MHz |\
 ...
 *
 * Description:
 *   Called to configure SPI chip select GPIO pins for the stm32f4AIIT
 *   board.
 *
 ****************************************************************************/
 ...
 *
 * Description:
 *   Called to configure I2S chip select GPIO pins for the stm32f4AIIT
 *   board.
 *
 ****************************************************************************/
 ...
 *   USB-related GPIO pins for the STM32F4AIIT board.
 *
 ****************************************************************************/
 ...
 *
 * Description:
 *   Enable logic to use the LEDs on the STM32F4AIIT to support power
 *   management testing
 *
 ****************************************************************************/
 ...
 *
 * Description:
 *   Configure the user button of the STM32f4AIIT board as EXTI,
...
#endif /* __ASSEMBLY__ */
#endif /* __BOARDS_ARM_STM32_AIIT_ARM32_BOARD_SRC_STM32F4AIIT_H */
