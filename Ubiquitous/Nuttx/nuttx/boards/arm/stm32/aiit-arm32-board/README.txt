...
ways:
  ...
  - The ST-LINK/V2 has been updated to ST-LINK/V2-A on STM32F4AIIT
...
-------------------------
  ...
  -------
    ...
    1. This configuration assumes that that you are using the STM32F4AIIT-BB
       base board with serial console on USART1.  If you are not using the
       STM32F4AIIT, then you will want to disable support for the base
       board.

         -CONFIG_STM32F4AIIT=y
         +# CONFIG_STM32F4AIIT is not set
