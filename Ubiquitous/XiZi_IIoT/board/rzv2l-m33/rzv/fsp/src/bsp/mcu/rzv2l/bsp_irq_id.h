...
typedef enum IRQn
{
    ...
    WDT2_PERROUT_M_IRQn        = 54,   /* IRQ No:54,  PERROUT_M */
                                       /* IRQ No:55,  Reserved */
    MHU_MSG0_S_IRQn          = 56,     /* IRQ No:56,  msg_ch0_s */
    MHU_MSG1_S_IRQn          = 57,     /* IRQ No:57,  msg_ch1_s */
    MHU_MSG2_S_IRQn          = 58,     /* IRQ No:58,  msg_ch2_s */
    MHU_MSG3_S_IRQn          = 59,     /* IRQ No:59,  msg_ch3_s */
    MHU_MSG4_S_IRQn          = 60,     /* IRQ No:60,  msg_ch4_s */
    MHU_MSG5_S_IRQn          = 61,     /* IRQ No:61,  msg_ch5_s */
    MHU_RSP0_S_IRQn          = 62,     /* IRQ No:62,  rsp_ch0_s */
    MHU_RSP1_S_IRQn          = 63,     /* IRQ No:63,  rsp_ch1_s */
    MHU_RSP2_S_IRQn          = 64,     /* IRQ No:64,  rsp_ch2_s */
    MHU_RSP3_S_IRQn          = 65,     /* IRQ No:65,  rsp_ch3_s */
    MHU_RSP4_S_IRQn          = 66,     /* IRQ No:66,  rsp_ch4_s */
    MHU_RSP5_S_IRQn          = 67,     /* IRQ No:67,  rsp_ch5_s */
    MHU_MSG0_NS_IRQn         = 68,     /* IRQ No:68,  msg_ch0_ns */
    MHU_MSG1_NS_IRQn         = 69,     /* IRQ No:69,  msg_ch1_ns */
    MHU_MSG2_NS_IRQn         = 70,     /* IRQ No:70,  msg_ch2_ns */
    MHU_MSG3_NS_IRQn         = 71,     /* IRQ No:71,  msg_ch3_ns */
    MHU_MSG4_NS_IRQn         = 72,     /* IRQ No:72,  msg_ch4_ns */
    MHU_MSG5_NS_IRQn         = 73,     /* IRQ No:73,  msg_ch5_ns */
    MHU_RSP0_NS_IRQn         = 74,     /* IRQ No:74,  rsp_ch0_ns */
    MHU_RSP1_NS_IRQn         = 75,     /* IRQ No:75,  rsp_ch1_ns */
    MHU_RSP2_NS_IRQn         = 76,     /* IRQ No:76,  rsp_ch2_ns */
    MHU_RSP3_NS_IRQn         = 77,     /* IRQ No:77,  rsp_ch3_ns */
    MHU_RSP4_NS_IRQn         = 78,     /* IRQ No:78,  rsp_ch4_ns */
    MHU_RSP5_NS_IRQn         = 79,     /* IRQ No:79,  rsp_ch5_ns */
    ...
    MTU0_TGIV_PLS_IRQn          = 174, /* IRQ No:174, TCIV0 */
    ...
    MTU1_TGIV_PLS_IRQn          = 179, /* IRQ No:179, TCIV1 */
    MTU1_TGIU_PLS_IRQn          = 180, /* IRQ No:180, TCIU1 */
    MTU2_TGIA_PLS_IRQn          = 181, /* IRQ No:181, TGIA2 */
    MTU2_TGIB_PLS_IRQn          = 182, /* IRQ No:182, TGIB2 */
    MTU2_TGIV_PLS_IRQn          = 183, /* IRQ No:183, TCIV2 */
    MTU2_TGIU_PLS_IRQn          = 184, /* IRQ No:184, TCIU2 */
    ...
    MTU3_TGIV_PLS_IRQn          = 189, /* IRQ No:189, TCIV3 */
    ...
    MTU4_TGIV_PLS_IRQn          = 194, /* IRQ No:194, TCIV4 */
    ...
    MTU6_TGIV_PLS_IRQn          = 202, /* IRQ No:202, TCIV6 */
    ...
    MTU7_TGIV_PLS_IRQn          = 207, /* IRQ No:207, TCIV7 */
    ...
    MTU8_TGIV_PLS_IRQn          = 212, /* IRQ No:212, TCIV8 */
    MTU8_TGIU_PLS_IRQn          = 213, /* IRQ No:213, TCIU8 */
