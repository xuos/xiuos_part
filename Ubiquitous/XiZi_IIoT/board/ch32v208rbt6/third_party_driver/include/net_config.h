...
#define WCHNET_TCP_MSS                536  /* Size of TCP MSS*/
...
#define ETH_RX_BUF_SZE                596  /* MAC receive buffer length, an integer multiple of 4 */
// #define ETH_TX_BUF_SZE                1520  /* MAC send buffer length, an integer multiple of 4 */
#define ETH_TX_BUF_SZE                596  /* MAC send buffer length, an integer multiple of 4 */
#else
...
#define TCP_RETRY_COUNT               10    /* The number of TCP retransmissions, the default value is 20 */
...
#define CFG0_TCP_RECV_COPY            0     /* TCP receive replication optimization, internal debugging use */
...
#define WCHNET_NUM_ARP_TABLE          4   /* Number of ARP lists */
