 ...
 * @brief support rt1062xb usart function and register to bus framework
 * @version 1.0
...
Description: support rt1062xb usart configure and usart bus register function
History:
1. Date: 2025-05-23
Author: AIIT XUOS Lab
Modification:
1. support rt1062xb usart configure, write and read
2. support rt1062xb usart bus device and driver register
*************************************************/
