...
/**
* @file connect_uart.c
* @brief support xidatong-riscv64-board uart function and register to bus framework
* @version 1.0 
...
Description: support xidatong-riscv64-board uart configure and uart bus register function
...
Author: AIIT XUOS Lab
Modification: 
1. support xidatong-riscv64-board uart configure, write and read
2. support xidatong-riscv64-board uart bus device and driver register
*************************************************/
